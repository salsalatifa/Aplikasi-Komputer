...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-001.png}
\begin{eulercomment}
Hitung luas ABC:
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-002.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-003.png}
...
>Q=[5,6]; plotPoint(Q,"Q"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-004.png}
\begin{eulerprompt}
>plotSegment(O,P,"q");
>plotSegment(P,Q,"o");
>plotSegment(Q,O,"p");
>lineThrough(O,P):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-005.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-006.png}
\begin{eulerprompt}
>norm(O-P)*norm(Q-D)/2
\end{eulerprompt}
\begin{euleroutput}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-008-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{2}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-010-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-016-large.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-020.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-022.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-023.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-027.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-031-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-032.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-037-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-040.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-044-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-050.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-052.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-057.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-059.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-060.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-063-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-066-large.png}
\begin{eulercomment}
...
>insimg(30);
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-067.png}
\begin{eulercomment}
Tentu saja,
...
\]
\end{eulerformula}
\eulerimg{2}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-072-large.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-076.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-079-large.png}
\eulerimg{0}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-080-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-083-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-091-large.png}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-095-large.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-097.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-099-large.png}
\eulerimg{1}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-100-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-102.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-105.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-109.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-110.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-111.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-112.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-113.png}
\begin{eulercomment}
\end{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-114.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-4,xmax=1,ymin=-2,ymax=2,hue=1,title="The minimum is on A");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-115.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-116.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-2,xmax=2,ymin=-2,ymax=2,hue=1,title="The Fermat point");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-117.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-118.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],points=1,add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-119.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-120.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],add=1,color=12,points=1);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-121.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-122.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-126.png}
...
>povend();
\end{eulerprompt}
\eulerimg{22}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-127.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{22}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-128.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-129.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_Salsa Latifatun Nisa Mulyani_22305141048-130.png}
